 ...
 * @author mage<br>
 * @version 1.0<br>
 * @CreateDate 2022/4/6 <br>
 * @see io.renren.modules.oss.controller <br>
 */
@RestController
...
public class FileController {
    ...
    @RequestMapping(path = "/fileDownLoader", method = RequestMethod.GET)
    public void fileDownloader(@RequestParam(value = "file") String file,
        ...
        try {
            ...
            os.write(OSSFactory.build().downloadFile(file));
        }
        catch (IOException e) {
